...
class Properties implements \Iterator
{
    ...
    public static function fromFile($propertiesFile)
    {
        ...
        if (false === $propertyData) {
            throw new \UnexpectedValueException('Property file at ' . $propertiesFile . ' contains errors and can not be parsed.');
        }
     ...
     *
     * @api
     * @param   \stubbles\Properties  $otherProperties
     * @return  \stubbles\Properties
     * @since   1.3.0
     */
     ...
     * of \stubbles\lang\Secret  an IllegalAccessException is thrown as
