...
/**
 * Test for net\stubbles\peer\http\HttpResponse.
 *
 * @group  peer
 * @group  peer_http
 */
class HttpResponseTestCase extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function chunkedResponseCanBeRead()
    {
        ...
        $this->assertInstanceOf('net\\stubbles\\peer\\HeaderList', $headerList);
