...
/**
 * Concrete instance of net\stubbles\lang\Enum.
 */
...
/**
 * Tests for net\stubbles\lang\Enum.
 *
 * @group  lang
 * @group  lang_core
 */
class EnumTestCase extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals("net\stubbles\lang\TestEnumWithoutValues {\n    FOO\n    FOO\n}\n",
    ...
    {
        $this->assertEquals("net\stubbles\lang\TestEnumWithValues {\n    FOO\n    10\n}\n",
    ...
    {
        $this->assertEquals(array(TestEnumWithoutValues::$FOO, TestEnumWithoutValues::$BAR),
    ...
    {
        $this->assertEquals(array('FOO', 'BAR'), TestEnumWithoutValues::namesOf());
    }
    ...
    {
        $this->assertEquals(array('FOO' => 10, 'BAR' => 20),
