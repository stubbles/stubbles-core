 ...
 *            string1='true',
 *            string2='null',
 *            class=net\stubbles\lang\reflect\annotation\parser\MyTestClass.class)
 */
...
/**
 * Test for net\stubbles\lang\reflect\annotation\parser\AnnotationStateParser.
 *
 * @group  lang
 * @group  lang_reflect
 ...
 */
class AnnotationStateParserTestCase extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $clazz                 = new \ReflectionClass('net\\stubbles\\lang\\reflect\\annotation\\parser\\MyTestClass');
        ...
        $this->assertEquals(array('__value' => 'This is a string with chars like = or ,'), $annotations['SingleStringValue']['params']);
        ...
        $this->assertInstanceOf('net\\stubbles\\lang\\reflect\\ReflectionClass', $annotations['WithTypes']['params']['class']);
        $this->assertEquals('net\\stubbles\\lang\\reflect\\annotation\\parser\\MyTestClass', $annotations['WithTypes']['params']['class']->getName());
    }
    ...
    {
        $method                = new \ReflectionMethod('net\\stubbles\\lang\\reflect\\annotation\\parser\\MyTestClass2', 'foo');
        $annotationStateParser = new AnnotationStateParser();
    ...
    {
        $method                = new \ReflectionMethod('net\\stubbles\\lang\\reflect\\annotation\\parser\\Bug202Class', 'foo');
        $annotationStateParser = new AnnotationStateParser();
        $annotations           = $annotationStateParser->parse($method->getDocComment());
        $this->assertTrue(isset($annotations['ForArgument1#bar']));
        $this->assertEquals('bar', $annotations['ForArgument1#bar']['argument']);
