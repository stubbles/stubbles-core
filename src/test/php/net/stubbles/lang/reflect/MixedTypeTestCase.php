...
/**
 * Test for net\stubbles\lang\reflect\MixedType.
 *
 * @since  3.1.1
 * @group  lang
 * @group  lang_reflect
...
class MixedTypeTestCase extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals('net\stubbles\lang\\reflect\MixedType[mixed] ' . "{\n}\n",
    ...
    {
        $this->assertEquals('net\stubbles\lang\\reflect\MixedType[object] ' . "{\n}\n",
