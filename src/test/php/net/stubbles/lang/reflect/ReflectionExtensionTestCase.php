...
/**
 * Test for net\stubbles\lang\reflect\ReflectionExtension.
 *
 * @group  lang
 * @group  lang_reflect
 */
class ReflectionExtensionTestCase extends \PHPUnit_Framework_TestCase
{
    /**
     * instance to test
     *
    ...
    {
        $this->assertEquals("net\\stubbles\\lang\\reflect\\ReflectionExtension[date] {\n}\n",
    ...
    public function returnsListOfReflectionFunction()
    {
        ...
        foreach ($refFunctions as $refFunction) {
            $this->assertInstanceOf('net\\stubbles\\lang\\reflect\\ReflectionFunction',
                                    $refFunction
            );
        }
    }
