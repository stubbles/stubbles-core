 ...
 *
 * @MyAnnotation(
 *     foo=stubbles\lang\reflect\annotation\AnyTestClass.class
 * )
 */
...
/**
 * Test for stubbles\lang\reflect\annotation\stubAnnotationFactory.
 *
 * @group  lang
 * @group  lang_reflect
 ...
 */';
    ...
    {
        $class = new ReflectionClass('stubbles\lang\\reflect\annotation\AnotherTestClass');
        $this->assertInstanceOf('stubbles\lang\\reflect\annotation\Annotation',
    ...
    {
        $class = new ReflectionClass('stubbles\lang\\reflect\annotation\AnyTestClass');
        ...
        $class2 = new ReflectionClass('stubbles\lang\\reflect\annotation\AnyTestClass');
    ...
    {
        $class = new ReflectionClass('stubbles\lang\\reflect\annotation\OneMoreTestClass');
